...
*/
    ...
    operationMap["-logplus1"] = new myLog();
    operationMap["-lag10"] = new Log10();
    operationMap["-exp"] = new Exp();
    operationMap["-expminus1"] = new myExp();
    ...
    operationMap["-stretch"] = new Stretch();
    ...
    operationMap["-detrend"] = new Detrend();
    operationMap["-detrend2"] = new Detrend2();
    operationMap["-whitebalance"] = new WhiteBalance();
    operationMap["-histoadapt"] = new HistoAdapt();
...
*/
    ...
    operationMap["-envelope2"] = new Envelope2();
    ...
    operationMap["-locallaplacian2"] = new myLocalLaplacian();
